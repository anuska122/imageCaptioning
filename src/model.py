...
def test_model():
    ...
    # Dummy captions (batch_size, max_length)  
    dummy_captions = torch.randint(0, vocab_size, (batch_size, max_length))
    ...
    # Test single image caption generation (would need real vocab)
    print("\nTesting single image processing...")
    single_image = torch.randn(3, 224, 224)
    
    # This would work with real vocabulary:
    # caption = model.generate_caption(single_image, vocab)
